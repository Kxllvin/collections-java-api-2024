...
public class ListaTarefas {
    ...
    public void marcarTarefaPendente(String descricao) {
        Tarefa marcarTarefasPendentes = null;
        for(Tarefa t : tarefaSet){
            if(t.getDescricao().equalsIgnoreCase(descricao)){
                marcarTarefasPendentes = t;
                break;
            }
        }

        if(marcarTarefasPendentes != null){
            if(marcarTarefasPendentes.isConcluido()){
                marcarTarefasPendentes.setConcluido(false);
            }
        } else{
